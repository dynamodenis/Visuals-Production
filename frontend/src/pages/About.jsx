    ...
    <div className='container mx-auto px-4 py-16 md:w-5xl'>
      <AnimateSection>
        <div className='flex flex-col items-center py-10'>
          <h2 className="text-3xl font-bold text-center flex flex-row justify-center items-center text-gray-900"><Eye className="mr-3 text-pink-600" /><span>About Us </span><AudioWaveform className="ml-2 text-pink-600" /></h2>
        </div>

        <div className=" flex flex-col gap-8">
          <div className='flex flex-col justify-center items-center gap-2'>
            <div className='text-lg font-semibold text-pink-600'>Our Mission</div>
          ...
          <div className='flex flex-col justify-center items-center gap-2'>
            <div className='text-lg font-semibold text-pink-600'>Our Vision</div>
          ...
          <div className='flex flex-col justify-center items-center gap-2'>
            <div className='text-lg font-semibold text-pink-600'>Our Values</div>
          ...
          <div className='flex flex-col items-center py-10'>
            <h2 className="text-3xl font-bold text-center flex flex-row justify-center items-center text-gray-900"><InboxIcon className="mr-3 text-pink-600" /><span>Customer Stories and Testimonials </span><HandCoinsIcon className="ml-2 text-pink-600" /></h2>
          </div>
        </div>
      </AnimateSection>
    </div>
