        ...
        <div className="bg-gray-50 p-6 rounded-lg">
          <div className="flex flex-row items-start gap-4">
            ...
            <div className='justify-start items-start'>
              <h3 className="text-lg text-gray-600 font-semibold mb-2">Mail address</h3>
              <p className="text-gray-600">dmbugua66@gmail.com</p>
              {/* <p className="text-gray-600">careers@kwetumarketingagency.co.ke</p> */}
            </div>
          </div>
        </div>
      </div>
        ...
        <form className="space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
              ...
              <div className="flex">
                <select className="px-2 py-2 border border-r-0 border-indigo-600 rounded-l-lg focus:outline-none focus:ring-2 focus:ring-indigo-500">
                  <option value="ke">🇰🇪 +254</option>
                </select>
                <input
                  type="tel"
                  className="w-full px-4 py-2 border border-indigo-600 rounded-r-lg focus:outline-none focus:ring-2 focus:ring-indigo-500"
